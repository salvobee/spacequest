...
tiledatamem	=	48		;hi-byte start address tile data (=$3000)

mapdata			=	$02		;16bit address map data for decoder
tiledata		=	$04		;16bit address tile data for decoder
tileX			=	$fc		;tile columns
tileY			=	$fd		;tile rows
NumberTilesX	=	$fe		;number of tiles from left to right
NumberTilesY	=	$ff		;number of tiles from top to bottom
map				=	$20		;16bit address map data for main program
attribs			= 	$22		;16bit address attributes (=colour)
screen			=	$24		;16bit screen address
mapX			= 	$26		;map width
